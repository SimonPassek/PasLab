...
- software development companys like windows, apple and co. produce usable, mostly good software
- but:
...
Lieber `r greetings[Name,1]`,
<br>
wollen wir uns am `r greetings[Name,3]` in `r greetings[Name,4]` treffen und eine `r greetings[Name,5]` unternehmen? Diese wir etwa `r lubridate::hour(lubridate::dmy_h(paste(greetings[Name,3], 3)))` Stunden dauern.
